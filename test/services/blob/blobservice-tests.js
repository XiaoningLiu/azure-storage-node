  ...
  describe('shared access signature', function () {
    describe('getBlobUrl', function () {
      ...
      it('should work with shared access policy', function (done) {
        ...
        assert.strictEqual(parsedUrl.query, 'se=2011-10-12T11%3A53%3A40Z&spr=https&sv=2016-10-16&sr=b&sig=B%2FzDv9s0T6qx8P0qLs6kzj6KO4I8yf8uFG5X1xdAcUE%3D');
        ...
        assert.strictEqual(parsedUrl.pathname, '/' + containerName + '/' + blobName);
        assert.strictEqual(parsedUrl.query, 'se=2011-10-12T11%3A53%3A40Z&spr=https&sv=2016-10-16&sr=b&sig=B%2FzDv9s0T6qx8P0qLs6kzj6KO4I8yf8uFG5X1xdAcUE%3D&snapshot=2016-10-11T11%3A03%3A40Z');
    ...
    it('GenerateSharedAccessSignature', function (done) {
      ...
      assert.equal(sasQueryString[QueryStringConstants.SIGNATURE], 'MdpMi6BKGrXhtGuqdJ2p8ImDfnwo6jZUqSP/e0xAiGs=');
