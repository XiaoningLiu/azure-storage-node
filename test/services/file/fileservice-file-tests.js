...
describe('File', function () {
  ...
  describe('getUrl', function() {
    ...
    it('Directory and file', function (done) {
      ...
      assert.strictEqual(url, 'https://host-secondary.com:88/account/' + share + '/' + directory + '/' + file + '?se=2011-10-12T11%3A53%3A40Z&sp=r&spr=https&sv=2016-10-16&sr=f&sig=840jtAttrrcyz1EpJHYN4EShN899u5uteHr97WXTFcY%3D');
