...
describe('tableservice-tests', function () {
  ...
  describe('getUrl', function(){
    it('should work', function(done) {
        ...
        assert.strictEqual(parsedUrl.query, 'se=2016-10-12T11%3A53%3A40Z&sp=r&spr=https&sv=2016-10-16&tn=table1&sig=pYgsIfvRQPyIfLFSGFjRaYU6uatUTEP3fz3cFT5iS50%3D');
        done();
    });
