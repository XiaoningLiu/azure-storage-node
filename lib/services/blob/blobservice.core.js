...
* @param {string}             [options.snapshotId]                        The snapshot identifier.
* @param {bool}               [options.isPermanentDelete]                 Specifies the specified blob and/or associated snapshots should be permanently deleted. Specified blob and/or snapshots should be soft deleted first.                                                                        
* @param {string}             [options.leaseId]                           The lease identifier.
* @param {AccessConditions}   [options.accessConditions]                  The access conditions.
* @param {LocationMode}       [options.locationMode]                      Specifies the location mode used to decide which location the request should be sent to. 
*                                                                         Please see StorageUtilities.LocationMode for the possible values.
...
BlobService.prototype.deleteBlob = function (container, blob, optionsOrCallback, callback) {
  ...
  if (options.isPermanentDelete) {
    webResource.withQueryOption(QueryStringConstants.DELETE_TYPE, BlobUtilities.DeleteTypes.PERMANENT);
    delete options.isPermanentDelete;
  }
